...
@pytest.fixture
def of_obj(projects, projects_results, msa, gene_tree, recon_method, sequence_search_threads, analysis_threads):
    return OrthoFinderTestFuncs(projects, projects_results, msa, gene_tree, recon_method, sequence_search_threads, analysis_threads)
